...
@layer utilities {
  ...
  .hud-glow {
    box-shadow: 0 0 calc(8px * var(--hud-intensity))
    ...
    <div aria-label="讲话状态栏" className="border-b border-border bg-card/30 px-4 py-2">
      <div className="mx-auto flex max-w-7xl items-center gap-3">
        <span className="hud-mono text-xs text-muted-foreground">
          [ SPEAKING BAR · PLACEHOLDER ]
        </span>
        <span className="hud-mono text-xs text-primary/60">Phase 4c 将实装实时讲话增强信息卡</span>
      </div>
    </div>
  )
}
...
export function LogsView() {
  return (
    <section className="hud-frame p-6">
      ...
      <p className="hud-mono text-sm text-muted-foreground">QSO 日志视图 · Phase 4b 实装</p>
    </section>
  )
}
```
...
export function Top20View() {
  return (
    <section className="hud-frame p-6">
      ...
      <p className="hud-mono text-sm text-muted-foreground">排行榜 · Phase 4d 实装</p>
    </section>
  )
}
```
...
export function OldFriendsView() {
  return (
    <section className="hud-frame p-6">
      ...
      <p className="hud-mono text-sm text-muted-foreground">老朋友 · Phase 4e 实装</p>
    </section>
  )
}
```
...
export function MessagesView() {
  return (
    <section className="hud-frame p-6">
      ...
      <p className="hud-mono text-sm text-muted-foreground">消息中心 · Phase 4f 实装</p>
    </section>
  )
}
```
...
export function SettingsView() {
  return (
    <section className="hud-frame p-6">
      ...
      <p className="hud-mono text-sm text-muted-foreground">设置 · Phase 4a 实装</p>
    </section>
  )
}
```
